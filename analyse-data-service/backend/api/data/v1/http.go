...
type DataHTTPServer interface {
	...
	ListEventSemanticResolutionRoutes(context.Context, *EventSemanticResolutionRouteRequest) (*Response[EventSemanticResolutionRouteResult], error)
	ListEventSemanticResolutionAnchors(context.Context, *EventSemanticResolutionAnchorRequest) (*Response[EventSemanticResolutionAnchorResult], error)
	ResolveEventSemanticChainNodeCandidates(context.Context, *EventSemanticResolutionCandidateRequest) (*Response[EventSemanticResolutionCandidateResult], error)
...
func RegisterDataHTTPServer(server *kratoshttp.Server, application DataHTTPServer) {
	...
	router.POST("/event-semantics/resolution-routes:list", listEventSemanticResolutionRoutesHandler(application))
	router.POST("/event-semantics/resolution-anchors:list", listEventSemanticResolutionAnchorsHandler(application))
	router.POST("/event-semantics/chain-node-candidates:resolve", resolveEventSemanticChainNodeCandidatesHandler(application))
