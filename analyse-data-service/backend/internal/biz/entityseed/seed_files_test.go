...
func TestAllianceOrgSeedFile(t *testing.T) {
	...
	for _, entity := range manifest.Entities {
		if entity.EntityType != model.EntityTypeAllianceOrg {
			t.Fatalf("entity %q type = %q, want %q", entity.Key, entity.EntityType, model.EntityTypeAllianceOrg)
		}
...
func TestEconomySeedFile(t *testing.T) {
	...
	for _, entity := range manifest.Entities {
		if entity.EntityType != model.EntityTypeEconomy {
			t.Fatalf("entity %q type = %q, want %q", entity.Key, entity.EntityType, model.EntityTypeEconomy)
		}
...
func TestPolicyBodySeedFile(t *testing.T) {
	...
	for _, entity := range manifest.Entities {
		if entity.EntityType != model.EntityTypePolicyBody {
			t.Fatalf("entity %q type = %q, want %q", entity.Key, entity.EntityType, model.EntityTypePolicyBody)
		}
...
func TestMarketSeedFile(t *testing.T) {
	...
	for _, entity := range manifest.Entities {
		if entity.EntityType != model.EntityTypeMarket {
			t.Fatalf("entity %q type = %q, want %q", entity.Key, entity.EntityType, model.EntityTypeMarket)
		}
...
func TestIndexSeedFile(t *testing.T) {
	...
	for _, entity := range manifest.Entities {
		if entity.EntityType != model.EntityTypeIndex {
			t.Fatalf("entity %q type = %q, want %q", entity.Key, entity.EntityType, model.EntityTypeIndex)
		}
		if strings.Contains(entity.Name, "台湾") && !strings.Contains(entity.Name, "中国台湾") {
			t.Fatalf("entity %q name = %q, want 中国台湾 political naming rule", entity.Key, entity.Name)
		}
...
func TestSectorSeedFile(t *testing.T) {
	...
	for _, entity := range manifest.Entities {
		if entity.EntityType != model.EntityTypeSector {
			t.Fatalf("entity %q type = %q, want %q", entity.Key, entity.EntityType, model.EntityTypeSector)
		}
...
func TestChainNodeSeedFile(t *testing.T) {
	...
	for _, entity := range manifest.Entities {
		if entity.EntityType != model.EntityTypeChainNode {
			t.Fatalf("entity %q type = %q, want %q", entity.Key, entity.EntityType, model.EntityTypeChainNode)
		}
	}
}
...
func TestMetricSeedFile(t *testing.T) {
	...
	for _, entity := range manifest.Entities {
		if entity.EntityType != model.EntityTypeMetric {
			t.Fatalf("entity %q type = %q, want %q", entity.Key, entity.EntityType, model.EntityTypeMetric)
		}
	}
}
...
func TestCommoditySeedFile(t *testing.T) {
	...
	for _, entity := range manifest.Entities {
		if entity.EntityType != model.EntityTypeCommodity {
			t.Fatalf("entity %q type = %q, want %q", entity.Key, entity.EntityType, model.EntityTypeCommodity)
		}
	}
}
...
func TestCompanySecuritySeedFiles(t *testing.T) {
	...
	for _, entity := range companies.Entities {
		if entity.EntityType != model.EntityTypeCompany {
			t.Fatalf("entity %q type = %q, want %q", entity.Key, entity.EntityType, model.EntityTypeCompany)
		}
	...
	for _, entity := range securities.Entities {
		if entity.EntityType != model.EntityTypeSecurity {
			t.Fatalf("entity %q type = %q, want %q", entity.Key, entity.EntityType, model.EntityTypeSecurity)
		}
...
func TestInstrumentSeedFile(t *testing.T) {
	...
	for _, entity := range manifest.Entities {
		if entity.EntityType != model.EntityTypeInstrument {
			t.Fatalf("entity %q type = %q, want %q", entity.Key, entity.EntityType, model.EntityTypeInstrument)
		}
	}
}
...
func TestPersonSeedFile(t *testing.T) {
	...
	for _, entity := range manifest.Entities {
		if entity.EntityType != model.EntityTypePerson {
			t.Fatalf("entity %q type = %q, want %q", entity.Key, entity.EntityType, model.EntityTypePerson)
		}
