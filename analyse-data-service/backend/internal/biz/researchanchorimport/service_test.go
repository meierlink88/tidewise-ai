...
func TestServiceRejectsPayloadAndPublisherConflicts(t *testing.T) {
	...
	changed := publication
	changed.Anchors = append([]Anchor(nil), publication.Anchors...)
...
func sharedPublication(t *testing.T) Publication {
	t.Helper()
...
func newFakeStore(publication Publication) *fakeStore {
...
func (f *fakeTx) ResearchAnchorImportThemePublication(context.Context, string) (*ThemePublication, error) {
	return f.theme, nil
}
...
func (f *fakeTx) InsertResearchAnchor(_ context.Context, anchor AnchorRecord) error {
...
func (f *fakeTx) InsertResearchAnchorEvent(_ context.Context, event EventRecord) error {
	f.events = append(f.events, event)
	return nil
}
func (f *fakeTx) InsertResearchAnchorPathNode(_ context.Context, node PathNodeRecord) error {
