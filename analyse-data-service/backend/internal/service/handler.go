...
type EventSemanticsService interface {
	...
	ListResolutionRoutes(context.Context, string, string) ([]eventsemantics.ResolutionRoute, error)
	ListResolutionAnchors(context.Context, string, string, string, []string, int, string) (eventsemantics.ResolutionAnchorPage, error)
	ResolveChainNodeCandidates(context.Context, string, string, []string, int, string) (eventsemantics.ResolutionCandidatePage, error)
