...
func TestResearchAndAdminQueriesUseSingleAggregateCalls(t *testing.T) {
	...
	admin := &fakeAdminStore{
		rawPage:   adminquery.RawDocumentPage{Page: 1, PageSize: 20, Items: []model.RawDocument{{ID: "11111111-1111-5111-8111-111111111111", ContractVersion: 2, ArtifactID: "artifact-1", SourceRef: "source:reuters:world", Title: "Raw", CollectedAt: time.Date(2026, 7, 17, 1, 0, 0, 0, time.UTC), IngestStatus: model.IngestStatusCollected}}},
		eventPage: adminquery.EventPage{Page: 1, PageSize: 20, Items: []model.Event{}},
	}
	...
	response = httptest.NewRecorder()
	handler.ServeHTTP(response, request)
	if response.Code != http.StatusOK || admin.rawCalls != 1 || admin.rawFilter.SourceRef != "source:reuters:world" || admin.rawFilter.IngestStatus != model.IngestStatusCollected {
...
func TestResearchHandlerNonEmptyGoldenPreservesAuthoritativeContract(t *testing.T) {
	...
	themeImpacts := []model.ImpactLevel{
		model.ImpactLevelHigh, model.ImpactLevelFocus, model.ImpactLevelWatch,
		model.ImpactLevelHigh,
	}
	themeStages := []model.TransmissionStage{
		model.TransmissionStageIdentification, model.TransmissionStageValidation,
		model.TransmissionStageDiffusion, model.TransmissionStageDampening,
	}
	...
	themes[0].RelatedIndices = []research.ResearchIndex{
		{ID: "33333333-3333-4333-8333-333333333333", Name: "正向", ImpactDirection: model.ResearchImpactPositive, ImpactSummary: "正向摘要"},
		{ID: "44444444-4444-4444-8444-444444444444", Name: "负向", ImpactDirection: model.ResearchImpactNegative, ImpactSummary: "负向摘要"},
		{ID: "55555555-5555-4555-8555-555555555555", Name: "混合", ImpactDirection: model.ResearchImpactMixed, ImpactSummary: "混合摘要"},
		{ID: "66666666-6666-4666-8666-666666666666", Name: "中性", ImpactDirection: model.ResearchImpactNeutral, ImpactSummary: "中性摘要"},
	}

	events := []research.ResearchEvent{
		{EventID: "aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa", Title: "驱动", Summary: "摘要", EventTime: &now, EvidenceRole: model.ResearchEvidenceDriver, SupportedClaim: "主张"},
		{EventID: "bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb", Title: "支持", Summary: "摘要", EvidenceRole: model.ResearchEvidenceSupporting, SupportedClaim: "主张"},
		{EventID: "cccccccc-cccc-4ccc-8ccc-cccccccccccc", Title: "反证", Summary: "摘要", EvidenceRole: model.ResearchEvidenceContradicting, SupportedClaim: "主张"},
		{EventID: "dddddddd-dddd-4ddd-8ddd-dddddddddddd", Title: "背景", Summary: "摘要", EvidenceRole: model.ResearchEvidenceContext, SupportedClaim: "主张"},
	}
