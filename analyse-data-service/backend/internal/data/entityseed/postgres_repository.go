...
func (r PostgresRepository) UpsertExternalIdentifier(ctx context.Context, identifier model.EntityExternalIdentifier) (WriteResult, error) {
...
func selectExternalIdentifierForUpdate(ctx context.Context, tx *sql.Tx, identifier model.EntityExternalIdentifier) (storedExternalIdentifier, bool, error) {
...
func reconcileExternalIdentifier(ctx context.Context, tx *sql.Tx, wanted model.EntityExternalIdentifier, existing storedExternalIdentifier) (WriteAction, error) {
...
func (r PostgresRepository) UpsertRelationship(ctx context.Context, relationship Relationship) (WriteResult, error) {
	...
	if relationship.Status != model.StatusActive && relationship.Status != model.StatusInactive {
...
func buildProfileUpsert(entityKey string, entityType model.EntityType, data []byte) (string, []any, error) {
...
func profileFields(entityType model.EntityType, data []byte) ([]profileField, error) {
...
func relationshipSeedUUID(key string) string {
	return bizidentity.NormalizeUUID("entity_relationship", key)
}

func sectorSourceMappingSeedUUID(identity string) string {
	return bizidentity.NormalizeUUID("sector_source_mapping", identity)
}
