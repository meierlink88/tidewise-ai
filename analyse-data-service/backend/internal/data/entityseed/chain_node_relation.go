...
func LoadChainNodeRelationManifest(path string) (ChainNodeRelationManifest, error) {
	return biz.LoadChainNodeRelationManifest(path)
}
...
func DryRunChainNodeRelations(ctx context.Context, repo chainNodeRelationSnapshotRepository, relations []model.ChainNodeRelation) (ChainNodeRelationReport, error) {
	return biz.DryRunChainNodeRelations(ctx, repo, relations)
}
...
func ValidateChainNodeRelationDryRunManifest(manifest ChainNodeRelationManifest) error {
	return biz.ValidateChainNodeRelationDryRunManifest(manifest)
}

type chainNodeRelationMemoryRepository struct {
	active map[string]struct{}
	values map[string]model.ChainNodeRelation
}

func newChainNodeRelationMemoryRepository(active []string) *chainNodeRelationMemoryRepository {
	r := &chainNodeRelationMemoryRepository{active: map[string]struct{}{}, values: map[string]model.ChainNodeRelation{}}
...
func (r *chainNodeRelationMemoryRepository) FindChainNodeRelationByID(_ context.Context, id string) (model.ChainNodeRelation, bool, error) {
	v, ok := r.values[id]
	return v, ok, nil
}
func (r *chainNodeRelationMemoryRepository) FindChainNodeRelationByTuple(_ context.Context, wanted model.ChainNodeRelation) (model.ChainNodeRelation, bool, error) {
	...
	return model.ChainNodeRelation{}, false, nil
}
func (r *chainNodeRelationMemoryRepository) UpsertChainNodeRelation(ctx context.Context, relation model.ChainNodeRelation) (WriteResult, error) {
	report, err := DryRunChainNodeRelations(ctx, r, []model.ChainNodeRelation{relation})
	if err != nil {
...
func (r PostgresRepository) FindChainNodeRelationByID(ctx context.Context, id string) (model.ChainNodeRelation, bool, error) {
	var v model.ChainNodeRelation
...
func (r PostgresRepository) FindChainNodeRelationByTuple(ctx context.Context, wanted model.ChainNodeRelation) (model.ChainNodeRelation, bool, error) {
	var v model.ChainNodeRelation
...
func (r PostgresRepository) UpsertChainNodeRelation(ctx context.Context, relation model.ChainNodeRelation) (WriteResult, error) {
	report, err := DryRunChainNodeRelations(ctx, r, []model.ChainNodeRelation{relation})
	if err != nil {
		return WriteResult{}, err
	}
