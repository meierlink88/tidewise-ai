...
func TestPostgresResearchReasoningTreeListReadsAndVerifiesPublishedSnapshot(t *testing.T) {
	...
	result, err := newRepository(db).ListResearchThemeReasoningTrees(context.Background(), reasoningThemeID)
	if err != nil {
		t.Fatal(err)
	}
...
func TestPostgresResearchReasoningTreeListRejectsReceiptCountDrift(t *testing.T) {
	...
	_, err = newRepository(db).ListResearchThemeReasoningTrees(context.Background(), reasoningThemeID)
...
func TestPostgresResearchReasoningTreeDetailKeepsEventAndPathOrder(t *testing.T) {
	...
	result, err := newRepository(db).GetResearchThemeReasoningTree(context.Background(), reasoningThemeID, reasoningAnchorID)
	if err != nil {
		t.Fatal(err)
	}
...
func TestPostgresResearchReasoningTreeDetailRejectsReceiptCenterDrift(t *testing.T) {
	...
	_, err = newRepository(db).GetResearchThemeReasoningTree(context.Background(), reasoningThemeID, reasoningAnchorID)
	if !errors.Is(err, ErrResearchReasoningTreeInvariant) {
