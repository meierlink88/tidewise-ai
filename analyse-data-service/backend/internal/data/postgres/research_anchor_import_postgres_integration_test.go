...
import (
	...
	app "github.com/meierlink88/tidewise-ai/analyse-data-service/backend/internal/biz/researchanchorimport"
	domainimport "github.com/meierlink88/tidewise-ai/analyse-data-service/backend/internal/biz/researchanchorimport"
...
func TestResearchAnchorImportPostgresIntegration(t *testing.T) {
	...
	service := app.NewService(postgres.NewResearchAnchorImportStore(db))
