...
func TestFileSourceListsVersionedMigrations(t *testing.T) {
	...
	if got, want := migrationVersions(migrations), []string{"000001", "000002", "000003", "000004", "000005", "000006", "000007", "000008", "000009", "000010", "000011", "000012", "000013", "000014", "000015", "000016", "000017", "000018", "000019", "000020", "000021", "000022", "000023", "000024", "000025", "000026", "000027", "000028", "000029", "000030", "000031", "000032", "000033", "000034", "000035", "000036", "000037", "000038", "000039", "000040", "000041", "000042"}; !reflect.DeepEqual(got, want) {
	...
	if migrations[27].Name != "000028_validate_chain_node_review_status.sql" {
		t.Fatalf("migration name = %q", migrations[27].Name)
	}
	if migrations[28].Name != "000029_add_event_publication_v2.sql" {
		t.Fatalf("migration name = %q", migrations[28].Name)
	}
	if migrations[29].Name != "000030_add_industry_relationship_import_contract.sql" {
		t.Fatalf("migration name = %q", migrations[29].Name)
	}
	if migrations[30].Name != "000031_rebuild_research_theme_reasoning_trees_v1.sql" {
		t.Fatalf("migration name = %q", migrations[30].Name)
	}
	if migrations[31].Name != "000032_add_event_semantics_phase_one.sql" {
		t.Fatalf("migration name = %q", migrations[31].Name)
	}
	if migrations[41].Name != "000042_add_evidence_publications.sql" {
		t.Fatalf("migration name = %q", migrations[41].Name)
	}
