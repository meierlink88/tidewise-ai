...
func TestClassifySeparatesMentionRetrievalSelectorAndReviewFailures(t *testing.T) {
	china := entityIdentity{ID: "china", EntityType: "economy", CanonicalName: "中国", Status: "active", EventLinkAllowed: true}
	brazil := entityIdentity{ID: "brazil", EntityType: "economy", CanonicalName: "巴西", Status: "active", EventLinkAllowed: true}
...
func TestExpectedFormalIdentitiesDoesNotTreatCompanySubstringAsEconomy(t *testing.T) {
	usa := entityIdentity{ID: "usa", EntityType: "economy", CanonicalName: "美国", Status: "active", EventLinkAllowed: true}
	gabon := entityIdentity{ID: "gabon", EntityType: "economy", CanonicalName: "加蓬", Aliases: []string{"GA"}, Status: "active", EventLinkAllowed: true}
	airline := entityIdentity{ID: "american-airlines", EntityType: "company", CanonicalName: "美国航空", Status: "active", EventLinkAllowed: true}
	...
	got = expectedFormalIdentities("Israel withdrew from Zawtar al-Gharbiyeh", []string{"以色列"}, []entityIdentity{
		gabon,
		{ID: "israel", EntityType: "economy", CanonicalName: "以色列", Status: "active", EventLinkAllowed: true},
	})
