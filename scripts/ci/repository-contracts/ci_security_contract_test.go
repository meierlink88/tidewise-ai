...
func TestCIWorkflowEnforcesQualityAndSecurityGates(t *testing.T) {
	...
	for _, required := range []string{
		...
		"Test Data migration framework",
		"Smoke Data forward migration chain",
		"Setup Python for OpenSPG schema validation",
		...
		"./data-service/backend/internal/data/entity/region",
	...
	for _, forbidden := range []string{
		...
		"go test -race ./data-service/backend/...",
