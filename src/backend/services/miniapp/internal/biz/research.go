...
func themeItemDTO(item ResearchTheme) ResearchThemeItem {
...
func themeChainNodeDTOs(values []ResearchThemeChainNode) []ResearchChainNodeDTO {
...
func indexDTOs(values []ResearchIndex) []ResearchIndexDTO {
