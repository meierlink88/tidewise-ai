...
func validReasoningTreeList(value ResearchReasoningTreeList, themeID string) bool {
...
func validReasoningTreeDetail(value ResearchReasoningTreeDetail, themeID, anchorID string) bool {
	...
	for _, event := range tree.Events {
		...
		if event.EvidenceRole == EvidenceRoleDriver {
			driverCount++
		}
		if event.EvidenceRole == EvidenceRoleContradicting {
...
func validReasoningTheme(value ResearchTheme) bool {
...
func validReasoningChainNode(value ResearchReasoningTreeChainNode) bool {
...
func validImpactLevel(value ImpactLevel) bool {
	switch value {
	case ImpactLevelHigh, ImpactLevelFocus, ImpactLevelWatch:
		return true
	default:
		return false
	}
...
func validTransmissionStage(value TransmissionStage) bool {
	switch value {
	case TransmissionStageIdentification,
...
func validImpactDirection(value ImpactDirection) bool {
	switch value {
	case ImpactDirectionPositive,
...
func validChangeDirection(value ChangeDirection) bool {
	switch value {
	case ChangeDirectionIncrease,
		ChangeDirectionDecrease,
		ChangeDirectionMixed,
		ChangeDirectionUnchanged,
		ChangeDirectionUncertain:
		return true
	default:
		return false
	}
...
func reasoningTreeEventDTOs(values []ResearchReasoningTreeEvent) []ResearchReasoningTreeEventDTO {
...
func reasoningTreePathNodeDTOs(values []ResearchReasoningTreePathNode) []ResearchReasoningTreePathNodeDTO {
