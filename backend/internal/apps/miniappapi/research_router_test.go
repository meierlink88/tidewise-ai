...
func TestResearchRoutesPreserveNonEmptyPublicThemeGoldenAndRequestID(t *testing.T) {
	...
	router := researchTestRouter(NewResearchService(client))
...
func TestResearchRoutesPreservePublicAnchorRelationSummaryGolden(t *testing.T) {
	...
	response := serveResearch(t, NewResearchService(client), "/api/v1/miniapp/research/anchors/11111111-1111-4111-8111-111111111111?window_hours=24")
...
func TestResearchRoutesPreserve400404And500WithoutUpstreamLeak(t *testing.T) {
	t.Run("invalid request", func(t *testing.T) {
		...
		response := serveResearch(t, NewResearchService(client), "/api/v1/miniapp/research/themes?limit=51")
	...
	for _, test := range []struct {
		...
		t.Run(test.name, func(t *testing.T) {
			...
			response := serveResearch(t, NewResearchService(client), "/api/v1/miniapp/research/themes/11111111-1111-4111-8111-111111111111")
...
func researchTestRouter(service *ResearchService) http.Handler {
...
func serveResearch(t *testing.T, service *ResearchService, path string) *httptest.ResponseRecorder {
	t.Helper()
	response := httptest.NewRecorder()
