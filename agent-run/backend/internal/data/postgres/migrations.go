...
var expectedSchemaColumns = map[string]string{
	...
	"event_publication_journal.work_item_key": "bpchar:NO", "event_publication_journal.batch_ordinal": "int2:NO",
...
func (s *Store) schemaShapeReady(ctx context.Context) bool {
	...
	`, []string{
		...
		"event_extractor_executions", "event_publication_journal", "event_fact_canonical_events",
	})
	if err != nil {
		return false
	}
