...
- [ ] 2.3 验证 receipt constraints/indexes、active tag count=22、Tag seed fixture、既有 raw/event/tag/event_entity_links 行数保留和 dry-run 零写入；保存 recovery/after assertions，不执行 UAT/prod/shared/Neo4j 或真实业务 import。
