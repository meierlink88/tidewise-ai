...
- 首批包含 AI 加速芯片/加速卡、HBM、高速互连与光模块、服务器电源、液冷系统、AI服务器、AI算力集群等直接硬件节点；排除完整半导体制造设备/材料链、通用云与 IDC 运营、模型/软件/应用、公司/证券、physical constraints。该方向与边界是本轮 Proposal Review 唯一待确认业务项，尚未宣称用户批准。
