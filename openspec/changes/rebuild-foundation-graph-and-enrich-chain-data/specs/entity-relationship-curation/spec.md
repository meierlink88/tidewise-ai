...
### Requirement: 842 节点全量候选分批审批
系统 SHALL 在 842 个基线 chain_node 的四类关系审计状态全部完整、候选与异常/冲突全部处置后，才能冻结全量 final 数据，并保持 PostgreSQL Write 与 Neo4j sync 独立授权。
...
- **THEN** 系统必须证明无待研究项、未处置候选、孤儿端点、重复 tuple 或未解决冲突，才能冻结 final 节点/关系数据
