...
func requiredScope(operation string) (string, bool) {
	...
	case reportapi.OperationGetReportAnalysisUnitChain, reportapi.OperationListReportAnalyses, reportapi.OperationGetReportAnalysis, reportapi.OperationGetReportAnalysisChain, reportapi.OperationListReports, reportapi.OperationGetReportHome, reportapi.OperationGetReportLayer,
