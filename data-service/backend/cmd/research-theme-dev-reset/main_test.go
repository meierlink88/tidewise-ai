...
func TestRunResetDryRunOnlyReadsCounts(t *testing.T) {
	...
	protected := protectedCounts{Events: 2, EntityNodes: 5, Industries: 7, Concepts: 4, ChainNodes: 3}
...
func TestRunResetDeletesOnlyResearchPublicationsAndRestoresTriggers(t *testing.T) {
	...
	defer db.Close()
	protected := protectedCounts{Events: 2, EntityNodes: 5, Industries: 7, Concepts: 4, ChainNodes: 3, IndustryChains: 1}
