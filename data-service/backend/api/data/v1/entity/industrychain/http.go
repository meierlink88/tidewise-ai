...
func RegisterHTTPServer(server *kratoshttp.Server, application Service) {
	...
	router.POST("/entities/industry-chains", createHandler(application))
	router.GET("/entities/industry-chains", listHandler(application))
	router.GET("/entities/industry-chains/{industry_chain_id}", getHandler(application))
	router.PUT("/entities/industry-chains/{industry_chain_id}", updateHandler(application))
}
func createHandler(application Service) kratoshttp.HandlerFunc {
	return func(ctx kratoshttp.Context) error {
		...
		return call(ctx, OperationCreate, request, func(callContext context.Context) (*v1.Response[IndustryChain], error) {
...
func listHandler(application Service) kratoshttp.HandlerFunc {
	return func(ctx kratoshttp.Context) error {
		...
		return call(ctx, OperationList, request, func(callContext context.Context) (*v1.Response[IndustryChainList], error) {
...
func getHandler(application Service) kratoshttp.HandlerFunc {
	return func(ctx kratoshttp.Context) error {
		request := &GetRequest{IndustryChainID: ctx.Vars().Get("industry_chain_id")}
		return call(ctx, OperationGet, request, func(callContext context.Context) (*v1.Response[IndustryChain], error) {
...
func updateHandler(application Service) kratoshttp.HandlerFunc {
	return func(ctx kratoshttp.Context) error {
		...
		request.IndustryChainID = ctx.Vars().Get("industry_chain_id")
		return call(ctx, OperationUpdate, request, func(callContext context.Context) (*v1.Response[IndustryChain], error) {
