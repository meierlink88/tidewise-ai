...
func RegisterHTTPServer(server *kratoshttp.Server, application Service) {
	...
	router.POST("/entities/industries", createHandler(application))
	router.GET("/entities/industries", listHandler(application))
	router.GET("/entities/industries/{industry_id}", getHandler(application))
	router.PUT("/entities/industries/{industry_id}", updateHandler(application))
}
...
func createHandler(application Service) kratoshttp.HandlerFunc {
	return func(ctx kratoshttp.Context) error {
		...
		return call(ctx, OperationCreate, request, func(callContext context.Context) (*v1.Response[Industry], error) {
...
func listHandler(application Service) kratoshttp.HandlerFunc {
	return func(ctx kratoshttp.Context) error {
		...
		return call(ctx, OperationList, request, func(callContext context.Context) (*v1.Response[IndustryList], error) {
...
func getHandler(application Service) kratoshttp.HandlerFunc {
	return func(ctx kratoshttp.Context) error {
		request := &GetRequest{IndustryID: ctx.Vars().Get("industry_id")}
		return call(ctx, OperationGet, request, func(callContext context.Context) (*v1.Response[Industry], error) {
...
func updateHandler(application Service) kratoshttp.HandlerFunc {
	return func(ctx kratoshttp.Context) error {
		...
		request.IndustryID = ctx.Vars().Get("industry_id")
		return call(ctx, OperationUpdate, request, func(callContext context.Context) (*v1.Response[Industry], error) {
