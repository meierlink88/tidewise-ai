...
func unifiedReasoningShape(geopolitical bool) *v1.StrictJSONShape {
	return v1.StrictJSONRequiredObject([]string{"local_key", "title", "assessment", "reasoning_summary", "reasoning_blocks", "affected_assets"}, map[string]*v1.StrictJSONShape{"local_key": v1.StrictJSONString(), "source_id": v1.StrictJSONString(), "assessment": unifiedAssessmentShape(geopolitical), "reasoning_summary": v1.StrictJSONRequiredObject([]string{"logic", "objections"}, map[string]*v1.StrictJSONShape{"logic": v1.StrictJSONString(), "support": v4ClaimShape(), "objections": v4ObjectionsShape()}), "graph": v5GraphShape(), "empty_state": v1.StrictJSONNullable(v1.StrictJSONRequiredObject([]string{"code", "reason", "follow_up"}, map[string]*v1.StrictJSONShape{"code": v1.StrictJSONString(), "reason": v1.StrictJSONString(), "follow_up": v1.StrictJSONArray(v1.StrictJSONString())})), "judgment_origin": v1.StrictJSONString(), "reasoning_sources": v5ReasoningSourcesShape(), "variable_signals": v1.StrictJSONArray(v5SignalShape()), "title": v1.StrictJSONString(), "affected_assets": v1.StrictJSONArray(unifiedNodeShape(geopolitical)), "reasoning_blocks": v1.StrictJSONArray(unifiedBlockShape())})
}

func unifiedAssessmentShape(geopolitical bool) *v1.StrictJSONShape {
	if !geopolitical {
		return v1.StrictJSONRequiredObject([]string{"conclusion", "direction", "conclusion_basis", "validation_status", "confidence", "forecast_window", "scope", "conditions", "follow_up", "transmission_logic", "evidence_ids"}, map[string]*v1.StrictJSONShape{"conclusion": v1.StrictJSONString(), "direction": v1.StrictJSONString(), "conclusion_basis": v1.StrictJSONString(), "validation_status": v1.StrictJSONString(), "confidence": v1.StrictJSONNullable(v1.StrictJSONString()), "forecast_window": v4WindowShape(), "scope": v1.StrictJSONString(), "conditions": v1.StrictJSONArray(v1.StrictJSONString()), "follow_up": v1.StrictJSONArray(v1.StrictJSONString()), "transmission_logic": v1.StrictJSONString(), "evidence_ids": v1.StrictJSONArray(v1.StrictJSONString()), "weight_delta_pp": v1.StrictJSONNumber(), "adjustment_purpose": v1.StrictJSONString()})
	}
	return v1.StrictJSONRequiredObject([]string{"conclusion", "direction", "conclusion_basis", "validation_status", "scope", "conditions", "transmission_logic", "evidence_ids"}, map[string]*v1.StrictJSONShape{"conclusion": v1.StrictJSONString(), "direction": v1.StrictJSONString(), "conclusion_basis": v1.StrictJSONString(), "validation_status": v1.StrictJSONString(), "confidence": v1.StrictJSONNullable(v1.StrictJSONString()), "forecast_window": v1.StrictJSONNullable(v1.StrictJSONRequiredObject(nil, map[string]*v1.StrictJSONShape{"kind": v1.StrictJSONString(), "description": v1.StrictJSONString(), "start_at": v1.StrictJSONNullable(v1.StrictJSONString()), "end_at": v1.StrictJSONNullable(v1.StrictJSONString())})), "scope": v1.StrictJSONString(), "conditions": v1.StrictJSONArray(v1.StrictJSONString()), "follow_up": v1.StrictJSONNullable(v1.StrictJSONArray(v1.StrictJSONString())), "transmission_logic": v1.StrictJSONString(), "evidence_ids": v1.StrictJSONArray(v1.StrictJSONString()), "weight_delta_pp": v1.StrictJSONNumber(), "adjustment_purpose": v1.StrictJSONString()})
}

func unifiedNodeShape(geopolitical bool) *v1.StrictJSONShape {
	return v1.StrictJSONRequiredObject([]string{"local_key", "source_id", "node_local_key", "name", "assessment", "objections"}, map[string]*v1.StrictJSONShape{"local_key": v1.StrictJSONString(), "source_id": v1.StrictJSONString(), "node_local_key": v1.StrictJSONString(), "name": v1.StrictJSONString(), "assessment": unifiedAssessmentShape(geopolitical), "objections": v4ObjectionsShape(), "judgment_origin": v1.StrictJSONString(), "reasoning_sources": v5ReasoningSourcesShape(), "variable_signals": v1.StrictJSONArray(v5SignalShape())})
}
