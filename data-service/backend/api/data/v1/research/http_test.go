...
func TestResearchThemeBindingAcceptsIsolatedAnalystSnapshotAndRejectsFormalIDs(t *testing.T) {
	...
	formalID := `,"chain_node_id":"ENT33333333-3333-4333-8333-333333333333"`
...
func TestResearchThemeBindingRequiresAtomicTreeAndLineageShape(t *testing.T) {
	payload := `{"analysis_batch_id":"batch","analysis_as_of":"2026-07-29T00:00:00Z","discovery_window_start":"2026-07-28T00:00:00Z","discovery_window_end":"2026-07-29T00:00:00Z","theme":{},"reasoning_trees":[{"industry_chain_id":"ENT22222222-2222-4222-8222-222222222222"}]}`
...
func TestResearchThemeBindingAcceptsAtomicAggregateShape(t *testing.T) {
	payload := `{
		...
		"theme":{},"reasoning_trees":[{
			"industry_chain_id":"ENT22222222-2222-4222-8222-222222222222",
			...
			"checkpoints":[],"events":[],"nodes":[{
				"position":1,"chain_node_id":"ENT33333333-3333-4333-8333-333333333333",
