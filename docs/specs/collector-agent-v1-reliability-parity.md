...
- `cloudwego/eino-ext` at `9137edd89e72b72735ede69db1c5ae29178a6e41`: audited `components/model/deepseek/{README.md,deepseek.go,option.go,deepseek_test.go,option_test.go,go.mod}` and `examples/generate/generate.go`. These confirm the existing DeepSeek structured JSON adapter remains appropriate. The reference contains general search tools but no Tavily, Bocha, CLS, Eastmoney or STCN adapter matching this direct-result contract.
