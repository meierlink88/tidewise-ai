...
- 计划日期：2026-07-20
- 当前阶段：TW-01 已验收，TW-02 已实施并完成本地验证
- 当前解锁任务：TW-02 验收
- 下一个门禁：用户验收 TW-02 后开始 TW-03 Spec 确认
...
- Theme 发布成功而 Anchor 发布失败时，保留 Theme 供重试，但在成功发布完整 Anchor 集合前不返回到首页 Theme 列表。
...
- 首页只查询已完整发布 Anchor 集合的 Theme，不增加 `has_reasoning_tree`。
...
- 删除未投入使用的旧独立 Anchor Miniapp API。
...
| TW-02 | 已确认 | 已完成 | 已通过 | 等待用户验收 |
| TW-03 | 未开始 | 未开始 | 未开始 | 未解锁 |
| TW-04 | 未开始 | 未开始 | 未开始 | 未解锁 |
| TW-05 | 未开始 | 未开始 | 未开始 | 未解锁 |
| TW-06 | 未开始 | 未开始 | 未开始 | 未解锁 |
| TW-07 | 未开始 | 未开始 | 未开始 | 未解锁 |
