...
1. `GET /api/miniapp/v1/research/themes/{theme_id}/reasoning-trees`
2. `GET /api/miniapp/v1/research/themes/{theme_id}/reasoning-trees/{anchor_id}`

每个 BFF 请求只调用一次对应的 Data API：

| Miniapp BFF | Data Service |
| --- | --- |
| `GET /api/miniapp/v1/research/themes/{theme_id}/reasoning-trees` | `GET /api/data/v1/research/themes/{theme_id}/reasoning-trees` |
| `GET /api/miniapp/v1/research/themes/{theme_id}/reasoning-trees/{anchor_id}` | `GET /api/data/v1/research/themes/{theme_id}/reasoning-trees/{anchor_id}` |
